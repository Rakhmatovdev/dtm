        ...
        <div className="flex gap-4 flex-col sm:flex-row">
          <div className="border p-4 w-full rounded space-y-2">
            <div className="fff justify-start sm:gap-28">
              <span className="utext sm:pr-[4px]">
                Product
              </span>
              <div className="fff sm:gap-10 gap-2">
                <form className="sm:w-48 mt-1 sm:mt-0 ">
                  <USelect options={OProduct} className="sm:h-9 sm:w-[200px]" control={control} name='product'/>
                </form>
            ...
            <div className="fff  sm:gap-32">
              <p className="utext sm:pr-[9px]">UUID</p>
