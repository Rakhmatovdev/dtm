        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex gap-2 flex-col sm:flex-row">
          <div className="border p-4 w-full space-y-2 rounded">
            ...
            <div className="fff  sm:gap-20">
              ...
              <UInput className="sm:max-w-[794px] sm:h-9" name="title_en" control={control}/>
            </div>
...
{/* image  */}
          ...
          <div className=" space-y-3 flex flex-col">
            <button type="submit" className="px-[75px] rounded font-bold text-white py-2 bg-blue-500 hover:bg-blue-600">Save</button>
            <button type="submit" className="px-[75px] rounded font-bold text-white py-2 bg-rose-500 hover:bg-rose-600">Delete</button>
