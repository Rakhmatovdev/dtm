...
const Register = () => {
  ...
  function onSubmit(values: z.infer<typeof registerSchema>) {
    if(values.password !==values.passwordVerify) (toast({title: "Password is not Valid",description: "Correct it and then send it.", }))
    console.log(values);
  }
  ...
  return (
    <div className="bg-foreground w-full h-screen   text-white">
      <div className="flex">
        <img  src={"/public/register-image.webp"}  alt="gfc" className=" w-1/2 h-screen dark:bg-primary-foreground bg-white"/>
